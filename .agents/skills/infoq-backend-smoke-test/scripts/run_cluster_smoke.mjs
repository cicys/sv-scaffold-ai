...
import {
    resolveBackendConfigSelection,
    resolveRedisEnv
} from '../../../../.codex/scripts/resolve_backend_local_mcp_env.mjs';
import {
    canConnect,
    fetchText,
...
function usage() {
  console.log(`Usage: node .agents/skills/infoq-backend-smoke-test/scripts/run_cluster_smoke.mjs [options]
