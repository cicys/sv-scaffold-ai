...
function usage() {
  console.log(`Usage:
  node .agents/skills/infoq-plugin-introducer/scripts/generate_plugin_plan.mjs --name <infoq-plugin-xxx> --class <fixed|reusable|toggle> [--frontend <none|vue|react|both|auto>] [--out <file>]

Examples:
  node .agents/skills/infoq-plugin-introducer/scripts/generate_plugin_plan.mjs --name infoq-plugin-audit --class reusable
  node .agents/skills/infoq-plugin-introducer/scripts/generate_plugin_plan.mjs --name infoq-plugin-sse --class toggle --frontend both --out doc/tmp/plugin-plan.md
`);
}
