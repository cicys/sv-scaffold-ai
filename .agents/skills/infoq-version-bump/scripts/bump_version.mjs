...
function usage() {
  console.log(`Usage: node .agents/skills/infoq-version-bump/scripts/bump_version.mjs [--dry-run] [--repo-root <path>] <x.y.z>
...
Examples:
  ...
  node .agents/skills/infoq-version-bump/scripts/bump_version.mjs --repo-root /path/to/infoq-scaffold-ai 2.0.3`);
}
