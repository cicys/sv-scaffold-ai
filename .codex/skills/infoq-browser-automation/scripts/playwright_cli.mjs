...
function printHelp() {
  console.log(`Usage:
  pnpm --dir .codex/skills/infoq-browser-automation/scripts run playwright-cli flow [options]
  pnpm --dir .codex/skills/infoq-browser-automation/scripts run playwright-cli admin-route-probe [options]
...
function printFlowHelp() {
  console.log(`Usage:
  pnpm --dir .codex/skills/infoq-browser-automation/scripts run playwright-cli flow --url <url> [options]
