...
node .codex/skills/infoq-login-success-check/scripts/verify_login.mjs --build

# Force auto temp backend (captcha disabled) on another port
node .codex/skills/infoq-login-success-check/scripts/verify_login.mjs --temp-port 18081
