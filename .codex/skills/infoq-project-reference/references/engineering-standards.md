...
- 提交或构建前执行仓库专用 UTF-8 校验命令：`node .codex/scripts/validate_utf8.mjs`；可追加路径参数做定向校验，例如 `node .codex/scripts/validate_utf8.mjs AGENTS.md infoq-scaffold-frontend-react/src`。
